...
<nav class="main-header navbar navbar-expand-md navbar-light navbar-white">
    <div class="container">
        <a href="<?= base_url() ?>" class="navbar-brand">
            ...
            <span class="brand-text font-weight-light"><b> Paminggir Printing</b></span>
        </a>
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul aria-labelledby="dropdownSubMenu1" class="dropdown-menu border-0 shadow">
                        ...
                        <li><a href="<?= 'https://wa.me/628990608234' ?>" class="dropdown-item">Contact Admin</a></li>
            ...
            <li class="nav-item">
                ...
                <?php } else { ?>
                    <a class="nav-link" data-toggle="dropdown" href="#">
                        ...
                        <img src="<?= base_url('assets/fotoprofile/' . $this->session->userdata('image')) ?>" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
                    </a>
