                        ...
                        <table class="table table-bordered">
                            ...
                            <?php foreach ($dikirim as $key => $value) { ?>
                                <tr>
                                    ...
                                    <td>
                                        <h4><?= $value->no_resi; ?><br>
                                            <button data-toggle="modal" data-target="#diterima<?= $value->id_transaksi ?>" href="" class="btn btn-sm btn-primary">Diterima</button>
                                        </h4>
                                    </td>
                                </tr>
                            <?php } ?>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer justify-content-between">
                    ...
                    <a href="<?= base_url('pesanan_saya/diterima/' . $value->id_transaksi) ?>" class="btn btn-primary">Iya</a>
                </div>
            </div>
            <!-- /.modal-content -->
        </div>
